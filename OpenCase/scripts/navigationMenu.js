$(function () {
    ...
    var menuHTML = '<div class="menu_playerInfo"><div id="menu_playerInfo_info"><a href="' + link + '" data-profileLink="true"><img src="../images/ava/' + Player.avatar + '" class="menu_ava"></a><div id="menu_playerInfo_info_text"><a href="' + link + '" data-profileLink="true"><span id="menu_playerInfo_name">' + Player.nickname + '</span></a><span id="menu_doubleBalance">' + Player.doubleBalance + '</span> <i class="double-icon"></i></div></div>' + '<div class="menu_rank"><img src="' + rank.img + '" id="left-rank"><img src="' + nextRank.img + '" style="float:right" id="right-rank"><div class="progress"><div class="progress-bar" id="player-rank-progress" style="width: ' + percent + '%"></div></div></div>' + '</div>';
    menuHTML += '<ul><li class="pushy-link"><a href="cases.html"><span class="icon icon-key2"></span><span id="local-menu-case" data-local="Open case">Открыть кейсы</span></a></li>' +
        ...
        '<li class="pushy-link"><a href="#crash-Online.html"><span class="icon icon-stats-dots"></span><span data-local="Crash">Краш <i>(исправляется)</i></span></a></li>' + 
        '</ul></li>' + 
